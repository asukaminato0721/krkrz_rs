//! Compatibility fallback for filename glob filters that rfd cannot represent.
use anyhow::Result;
use eframe::egui;
use krkrz_runtime::file_dialog::{FileDialog, FileSelection};
use std::{cell::RefCell, path::PathBuf, rc::Rc};

pub fn show(request: FileDialog) -> Result<Option<FileSelection>> {
...
pub(super) fn with_default_extension(mut path: PathBuf, filter: &str, default: &str) -> PathBuf {
...
pub(super) fn matches_filter(name: &str, patterns: &str) -> bool {
